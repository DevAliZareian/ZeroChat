import { Avatar, Box, Divider, Flex, HStack, Icon, Image, Text, VStack } from "@chakra-ui/react";
...
export default function ContactDetails() {
  return (
    <Flex direction="column" w="300px" h="100vh" borderLeft="1px solid" borderColor={colors.layout.border} bg={colors.layout.surface} px={4} py={6} overflowY="auto">
      {/* === Date & Notification === */}
      <Flex justify="space-between" align="center" mb={8}>
        <Text fontSize="sm" color={colors.text.secondary}>
          20 March 2021
        </Text>
        <IoMdNotifications size={20} color={colors.text.secondary} />
      </Flex>
      ...
      <VStack spacing={2} mb={6}>
        ...
        <HStack spacing={4}>
          <Icon as={FaGlobe} boxSize={4} color={colors.text.secondary} />
          <Icon as={FaInstagram} boxSize={4} color={colors.text.secondary} />
          <Icon as={FaTwitter} boxSize={4} color={colors.text.secondary} />
        </HStack>
      </VStack>
      ...
      <Flex justify="space-between" align="center" mb={2}>
        ...
        <Text fontSize="xs" color={colors.accent.blue} cursor="pointer">
          see all
        </Text>
      </Flex>
      ...
      <VStack spacing={3} align="stretch">
        {[
          ...
          <HStack key={i} spacing={3}>
            <Icon as={FiDribbble} color={colors.accent.blue} />
            <Box>
              <Text fontSize="sm" color={colors.text.primary}>
                {link.title}
              </Text>
